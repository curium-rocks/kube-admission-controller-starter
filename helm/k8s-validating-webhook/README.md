...
A starter template for a dynamic admission validating webhook
...
| blockedImages[0] | string | `"badbox"` |  |
| certmanager.enabled | bool | `true` |  |
| certmanager.useSelfSignedIssuer | bool | `true` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"Always"` |  |
| image.repository | string | `"ghcr.io/curium-rocks/k8s-validating-webhook"` |  |
...
| tlsSecretName | string | `"k8s-validating-webhook"` |  |
| tolerations | list | `[]` |  |
